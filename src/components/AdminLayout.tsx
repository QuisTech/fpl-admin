...
export function AdminLayout() {
  ...
  if (isAdmin === null) {
    return (
      <div className="min-h-screen bg-[#bb1a34] flex items-center justify-center">
  ...
  if (isAdmin === false) {
    return (
      <div className="min-h-screen bg-[#bb1a34] flex flex-col items-center justify-center text-white">
  ...
  return (
    <div className="min-h-screen bg-[#bb1a34] text-white flex">
      {/* Sidebar */}
      ...
      {/* Main Content */}
      <div className="flex-1 overflow-auto bg-[#bb1a34] p-8 relative">
